...
const HomePage = ({ user, onNavigate, onLogout }) => {
  ...
  return (
    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
        <a href="https://t.me/+GIJ2Yl0IaGFmOWVk" target="_blank" rel="noopener noreferrer" className="block mb-8 bg-gradient-to-r from-blue-600 to-blue-500 rounded-2xl p-4 hover:from-blue-500 hover:to-blue-400 transition-all">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
